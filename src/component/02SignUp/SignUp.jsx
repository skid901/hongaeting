      ...
      <ThemeProvider theme={mainTheme}>
        ...
        <Container className="input" maxWidth="sm">
          <FormControl fullWidth>
            ...
            <Input
              ...
              required
            />
            <FormHelperText style={{ 'letter-spacing': '0.03em' }}>
        ...
        <Container className="input" maxWidth="sm">
          <FormControl fullWidth>
            ...
            />
            <FormHelperText
              style={{ 'letter-spacing': '0.03em', 'font-size': '11px' }}
            >
        ...
        <Container className="input" maxWidth="sm">
          <FormControl fullWidth>
            ...
            />
            <FormHelperText
              style={{ 'letter-spacing': '0.03em', 'font-size': '0.73rem' }}
            >
          ...
          <Paper className="notice">
            <Typography
              variant="h6"
              gutterBottom
              style={{ 'letter-spacing': '0.00em', 'font-size': '1.2rem' }}
            >
              {`아직 홍익대학교 이메일이 없으신가요?`}
            </Typography>
            ...
            <Typography
              variant="body2"
              gutterBottom
              style={{ 'letter-spacing': '0.01em', 'font-size': '0.85rem' }}
            >
              <a
              ...
              {`으로 들어가 "Office365 가입하기"를 눌러주세요. `}import React, { useState, useContext } from 'react';
import { useHistory } from 'react-router-dom';
import { observer, MobXProviderContext } from 'mobx-react';
import axios from 'axios';
import './SignUp.scss';
